...
const customConfig: Linter.Config[] = [
          ...
          patterns: [
            {
              group: ['@super/*'],
              message:
                'The @core package cannot import the @super package, please use the @core package itself',
            },
          ],
        },
      ],
  ...
  {
    // @core/shared内部组件，不能引入@super/* 或者 @super-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@super/*', '@super-core/*'],
              message:
                'The @super-core/shared package cannot import the @super package, please use the @core/shared package itself',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: ['@super/*'],
              message:
                'The @super package cannot be imported, please use the @core package itself',
            },
          ],
        },
      ],
