...
import type { ImageUploadOptions } from '@super/plugins/tiptap';

import { computed, ref } from 'vue';

import { Page } from '@super/common-ui';
import { SuperTiptap, SuperTiptapPreview } from '@super/plugins/tiptap';
...
<template>
  <Page title="Tiptap 富文本">
    ...
    <Card class="mb-5" title="富文本预览">
      <SuperTiptapPreview :content="previewContent" />
    </Card>
