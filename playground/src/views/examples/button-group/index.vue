...
import {
  ...
  SuperButton,
  SuperButtonGroup,
  SuperCheckButtonGroup,
} from '@super/common-ui';
import { LoaderCircle, Square, SquareCheckBig } from '@super/icons';

import { Button, Card, message } from 'antdv-next';

import { useSuperForm } from '#/adapter/form';
...
<template>
  <Page
    title="SuperButtonGroup 按钮组"
    description="SuperButtonGroup是一个按钮容器，用于包裹一组按钮，协调整体样式。SuperCheckButtonGroup则可以作为一个表单组件，提供单选或多选功能"
  >
    <Card title="基本用法">
      <template #extra>
      ...
      <div class="mt-2 flex flex-col gap-2">
        <SuperButtonGroup v-bind="compProps" border>
          <SuperButton
