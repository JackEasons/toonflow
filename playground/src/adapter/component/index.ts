 ...
 * 可用于 super-form、super-modal、super-drawer 等组件使用,
 */
...
import type { Sortable } from '@super/hooks';
import type { TipTapProps } from '@super/plugins/tiptap';
...
import {
  ...
  globalShareState,
  IconPicker,
  SuperCollapsibleParams,
  VCropper,
} from '@super/common-ui';
import { useSortable } from '@super/hooks';
import { IconifyIcon } from '@super/icons';
import { $t } from '@super/locales';
import { SuperTiptap } from '@super/plugins/tiptap';
import { isEmpty } from '@super/utils';
...
async function initComponentAdapter() {
  const components: Partial<Record<ComponentType, Component>> = {
    ...
    RangePicker,
    Rate,
    RichEditor: withDefaultPlaceholder(SuperTiptap, 'input', {
      imageUpload: {
    ...
    CollapsibleParams: SuperCollapsibleParams,
  };
