...
import { registerLoadingDirective } from '@super/common-ui';
import { providePluginsOptions } from '@super/plugins';
import { preferences } from '@super/preferences';
import { initStores } from '@super/stores';
import '@super/styles';
import '@super/styles/antdv-next';
...
import { initSetupSuperForm, useSuperForm } from './adapter/form';
