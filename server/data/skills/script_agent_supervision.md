...
4. **追看卡点分布**：是否按≈10%/30%/50%/70%/90%比例分布；是否满足5大标准（关键瞬间、根本性改变、好奇心、高燃场景、爱情拉扯）；是否有假目标卡点设计
...
4. **删减合理性**：优先删除项（拖沓铺垫/重复内容/载体不支持/弱支线）是否正确；优先保留项（情绪点/关系拉扯/卡点铺垫/信息差场景/打脸时刻）是否覆盖
...
2. 从【项目配置】读取：集数、单集时长、追看卡点策略、章节范围
...
| 追看卡点分布 | 按≈10%/30%/50%/70%/90%比例分布，满足追看卡点5大标准；有假目标卡点设计（→ Skills 一-4） | 严重 |
...
#### 追看卡点分布验证（严重）
- 追看卡点按≈10%/30%/50%/70%/90%×总集数N分布（四舍五入取整），偏差超过±2集标记问题
- 逐一检查5大标准：①选择关键瞬间 ②设置根本性改变 ③调动好奇心 ④善用高燃场景 ⑤关注爱情拉扯（感情流）
- 追看卡点场景应具备"场面宏大、事态紧急、围观群众多"的特征
- 是否设计了假目标卡点（目标近在咫尺却落空）

#### 前10%黄金结构验证（中等）
- 第1-2集（或等比位置）：是否快速引入强烈冲突，实现"一秒入坑"
- 第3-4集：是否明确主角核心行动目标
- 第5-8集：是否引入多方配角施压
- 第9-10集：是否有假目标卡点+正式卡点的小高潮
...
| 删减合理性 | 删减遵循优先级原则；优先保留情绪点/关系拉扯/卡点铺垫/信息差/打脸时刻（→ Skills 二-4） | 中等 |
