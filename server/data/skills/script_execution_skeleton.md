...
- 压缩比 ≤ 40%
- 每集必须有集末钩子
- 追看卡点策略按【项目配置】执行；所有作品默认免费观看，卡点只用于剧情节奏与追看动力，不表达付费或解锁含义
...
| 第9-10集 | 设置"假目标卡点"（目标近在咫尺却落空）+ 正式卡点，推向小高潮 |

- 微短篇：卡点集提前至第6-7集，第1集需承载常规短剧3-4集信息量

### 三、追看卡点设置规范

根据【项目配置】总集数 N 按比例计算追看卡点位置（四舍五入取整）：
...
**追看卡点核心特征：** 场面宏大、事态紧急、围观群众多（大型宴会、认亲仪式、新闻发布会、婚礼现场等）

**假目标卡点：** 可多次设置，让观众误以为目标即将达成实则受阻，持续牵引情绪
...
**甜宠类：**
契约绑定（第1集）→ 误会拉扯升温（2%~9%）→ 秘密曝光（≈10%卡点）→ 情感破冰（11%~29%）→ 危机爆发（≈30%卡点）→ 撒糖+打脸反派（31%~59%）→ 新危机（≈60%）→ 情感确认（61%~80%）→ 圆满结局（81%~100%）
...
| 集 | 集标题 | 章节范围 | 戏剧功能 | 场景核心 | 章节处理 | 集末钩子 | 追看卡点 |
|----|--------|----------|----------|----------|----------|----------|--------|
