...
import { useRefresh } from '@super/hooks';
import { RotateCw } from '@super/icons';
import { preferences, usePreferences } from '@super/preferences';
import { useAccessStore } from '@super/stores';

import { SuperFullScreen, SuperIconButton } from '@super-core/shadcn-ui';
  ...
  >
    <slot :name="slot.name">
      <template v-if="slot.name === 'refresh'">
        <SuperIconButton class="my-0 mr-1 rounded-md" @click="refresh">
