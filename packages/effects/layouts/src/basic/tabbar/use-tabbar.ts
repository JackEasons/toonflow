...
import type { TabDefinition } from '@super/types';

import type { IContextMenuItem } from '@super-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@super/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@super/stores';
import { filterTree } from '@super/utils';
