...
import type { MenuRecordRaw } from '@super/types';

import { nextTick, onMounted, ref, shallowRef, watch } from 'vue';
import { useRouter } from 'vue-router';

import { SearchX, X } from '@super/icons';
import { $t } from '@super/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@super/utils';

import { SuperIcon, SuperScrollbar } from '@super-core/shadcn-ui';
import { isHttpUrl } from '@super-core/shared/utils';
  ...
  <SuperScrollbar>
    <div class="flex! h-full justify-center px-2 sm:max-h-112.5">
      ...
      <ul v-show="searchResults.length > 0" class="w-full">
        ...
        >
          <SuperIcon :icon="item.icon" class="mr-2 size-5 shrink-0" fallback />
