...
import { Bell, CircleCheckBig, CircleX, MailCheck } from '@super/icons';
...
<template>
  <SuperPopover v-model:open="open" content-class="relative right-2 w-90 p-0">
    <template #trigger>
      <div class="mr-2 flex-center h-full" @click.stop="toggle()">
        <SuperIconButton class="bell-button relative text-foreground">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <SuperScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <SuperButton size="sm" @click="handleViewAll">
