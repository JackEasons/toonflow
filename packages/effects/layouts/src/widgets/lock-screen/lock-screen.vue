...
import { LockKeyhole } from '@super/icons';
import { $t, useI18n } from '@super/locales';
import { storeToRefs, useAccessStore } from '@super/stores';

import { useScrollLock } from '@super-core/composables';
...
const [Form, { form, validate, getFieldComponentRef }] = useSuperForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    <transition name="slide-right">
      ...
      >
        <div class="mb-10 flex-col-center w-[90%] max-w-75 px-4">
          <SuperAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <SuperButton class="enter-x w-full" @click="handleSubmit">
