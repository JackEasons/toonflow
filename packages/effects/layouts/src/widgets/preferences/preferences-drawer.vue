...
import type { SupportedLanguagesType } from '@super/locales';
import type { CustomPreferencesRecord } from '@super/preferences';
import type {
  BreadcrumbStyleType,
  BuiltinThemeType,
  ContentCompactType,
...
import type { SegmentedItem } from '@super-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, Pin, PinOff, RotateCw } from '@super/icons';
import { $t, loadLocaleMessages } from '@super/locales';
import {
  clearCache,
  preferences,
  resetPreferences,
...
import { useSuperDrawer } from '@super-core/popup-ui';
import {
  SuperButton,
  SuperIconButton,
  SuperSegmented,
