...
import { SuperLoading, SuperSpinner } from '@super-core/shadcn-ui';
import { isString } from '@super-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(SuperLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(SuperSpinner, getOptions(binding));
    render(instance, el);
