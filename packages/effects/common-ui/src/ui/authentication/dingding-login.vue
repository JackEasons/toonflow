...
import { SvgDingDingIcon } from '@super/icons';
import { $t } from '@super/locales';

import { alert, useSuperModal } from '@super-core/popup-ui';
import { SuperIconButton } from '@super-core/shadcn-ui';
import { loadScript } from '@super-core/shared/utils';
...
const [Modal, modalApi] = useSuperModal({
  header: false,
  footer: false,
