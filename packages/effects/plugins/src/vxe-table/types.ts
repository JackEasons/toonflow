...
import type { ClassType, DeepPartial } from '@super/types';

import type { BaseFormComponentType, SuperFormProps } from '@super-core/form-ui';
...
> {
   ...
   * 表单配置
   */
  formOptions?: SuperFormProps<D, P>;
  /**
   * 显示搜索表单
   */
...
export interface SetupVxeTable {
  ...
  useSuperForm?: typeof useSuperForm;
}
