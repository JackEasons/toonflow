import type { SuperPluginsOptions } from './types';

let globalPluginsOptions: null | SuperPluginsOptions = null;

export function providePluginsOptions(options: SuperPluginsOptions) {
