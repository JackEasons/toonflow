...
import type { ImageUploadOptions, SuperTiptapExtensionOptions } from './types';

import { $t } from '@super/locales';

import { alert } from '@super-core/popup-ui';
  ...
  return Image.extend({
    ...
    addNodeView() {
      return ({ node }) => {
        ...
        wrapper.className = 'super-tiptap-upload-wrapper';

        const img = document.createElement('img');
        img.src = node.attrs.src;
        img.className = 'super-tiptap__image';
        wrapper.append(img);

        const spinner = document.createElement('div');
        spinner.className = 'super-tiptap-upload-spinner';
        wrapper.append(spinner);

        const progressBar = document.createElement('div');
        progressBar.className = 'super-tiptap-upload-progress';
        const progressFill = document.createElement('div');
        progressFill.className = 'super-tiptap-upload-progress-fill';
...
export function createDefaultTiptapExtensions(
  options: SuperTiptapExtensionOptions = {},
): Extensions {
  return [
