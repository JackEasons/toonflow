...
import { SuperIcon, SuperTooltip } from '@super-core/shadcn-ui';
    ...
    >
      ...
      >
        <template #trigger>
          <div :class="[nsMenu.be('tooltip', 'trigger')]">
            <SuperIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
            <slot></slot>
      ...
      <div v-show="!showTooltip" :class="[e('content')]">
        <MenuBadge
          ...
          v-bind="props"
        />
        <SuperIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
        <slot></slot>
        <slot name="title"></slot>
      </div>
    </a>
