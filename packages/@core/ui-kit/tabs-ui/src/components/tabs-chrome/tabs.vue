...
import type { TabDefinition } from '@super-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@super-core/icons';
import { SuperContextMenu, SuperIcon } from '@super-core/shadcn-ui';

interface Props extends TabsProps {}

defineOptions({
  name: 'SuperTabsChrome',
  inheritAttrs: false,
});

const props = withDefaults(defineProps<Props>(), {
  contentClass: 'super-tabs-content',
  contextMenus: () => [],
  gap: 7,
  tabs: () => [],
});
