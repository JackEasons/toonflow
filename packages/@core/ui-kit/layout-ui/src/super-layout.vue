...
import type { SuperLayoutProps } from './super-layout';
...
import { IconifyIcon } from '@super-core/icons';
import { SuperIconButton } from '@super-core/shadcn-ui';
...
interface Props extends SuperLayoutProps {}
