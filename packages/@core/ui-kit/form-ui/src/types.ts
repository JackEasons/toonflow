...
import type { SuperButtonProps } from '@super-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@super-core/typings';
...
export interface ActionButtonOptions extends SuperButtonProps {
  [key: string]: any;
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<SuperFormProps>>(
    selector?: (state: NoInfer<SuperFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface SuperFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
