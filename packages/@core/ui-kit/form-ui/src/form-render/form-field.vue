...
import { ChevronsDown, CircleAlert } from '@super-core/icons';
import {
  Button,
  FormControl,
  FormDescription,
...
import { cn, isFunction, isObject, isString } from '@super-core/shared/utils';
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <template v-if="label">
          <SuperRenderContent :content="label" />
        </template>
        <template #extra>
          <Button
            class="ml-0.5"
      ...
      <div class="flex-auto overflow-hidden p-px">
        <SuperCollapsible :show-trigger="false" v-model:open="collapseOpen">
          <template #collapsibleContent>
            <div :class="cn('relative flex w-full items-center', wrapperClass)">
              ...
              <div v-if="suffix" class="ml-1">
                <SuperRenderContent :content="suffix" />
              </div>
            </div>
          </template>
        </SuperCollapsible>
        ...
        <FormDescription v-if="description" class="text-xs">
          <SuperRenderContent :content="description" />
        </FormDescription>
