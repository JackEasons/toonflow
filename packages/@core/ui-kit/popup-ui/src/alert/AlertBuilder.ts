...
import type { Recordable } from '@super-core/typings';

import type { AlertProps, BeforeCloseScope, PromptProps } from './alert';

import { h, nextTick, ref, render } from 'vue';

import { useSimpleLocale } from '@super-core/composables';
import { Input, SuperRenderContent } from '@super-core/shadcn-ui';
import { isFunction, isString } from '@super-core/shared/utils';
...
export function superAlert(options: AlertProps): Promise<void>;
export function superAlert(
  message: string,
...
export function superConfirm(options: AlertProps): Promise<void>;
export function superConfirm(
  message: string,
  options?: Partial<AlertProps>,
): Promise<void>;
export function superConfirm(
...
export function superConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? superAlert(arg0, defaultProps)
      : superAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? superAlert(arg0 as string, arg1, defaultProps)
      : superAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return superAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function superPrompt<T = any>(
  ...
  const staticContents: Component[] = [
    h(SuperRenderContent, { content, renderBr: true }),
  ];
