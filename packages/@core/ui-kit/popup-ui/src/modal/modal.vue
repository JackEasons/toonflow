...
import { usePriorityValues, useSimpleLocale } from '@super-core/composables';
import { Expand, Shrink } from '@super-core/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  SuperLoading,
  VisuallyHidden,
} from '@super-core/shadcn-ui';
import { ELEMENT_ID_MAIN_CONTENT } from '@super-core/shared/constants';
import { globalShareState } from '@super-core/shared/global-state';
...
<template>
  ...
  >
    ...
    >
        ...
        <DialogTitle v-if="title" class="text-left">
          <slot name="title">
            ...
            <slot v-if="titleTooltip" name="titleTooltip">
              <SuperHelpTooltip trigger-class="pb-1">
                {{ titleTooltip }}
              </SuperHelpTooltip>
            </slot>
          </slot>
      ...
      <SuperLoading v-if="showLoading || submitting" spinning />
      <SuperIconButton
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || SuperButton"
          ...
          <component
            :is="components.PrimaryButton || SuperButton"
