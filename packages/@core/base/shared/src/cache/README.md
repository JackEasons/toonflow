...
```typescript
import { StorageManager } from '@super-core/shared/cache';
...
```typescript
import { LocalStorageDriver, StorageManager } from '@super-core/shared/cache';
...
```typescript
import {IndexedDBDriver, StorageManager} from '@super-core/shared/cache';

const cache = new StorageManager({
  driver: new IndexedDBDriver({
    dbName: 'my-app-db',     // 数据库名称，默认 'super-storage'
...
```typescript
import { MemoryStorageDriver, StorageManager } from '@super-core/shared/cache';
...
```typescript
import type { IStorageDriver } from '@super-core/shared/cache';
